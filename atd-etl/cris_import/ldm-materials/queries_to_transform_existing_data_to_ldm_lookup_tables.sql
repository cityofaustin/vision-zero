...
SET    prsn_type_id =
       ...
       --drvr_lic_type_id = ( select id from public.drvr_lic_type where true and source = 'cris' and cris_id = cris.atd_txdot_primaryperson.drvr_lic_type_id::integer ),
       --drvr_lic_state_id = ( select id from public.state where true and source = 'cris' and cris_id = cris.atd_txdot_primaryperson.drvr_lic_state_id::integer ),
       drvr_lic_cls_id =
       (
              SELECT id
