...
export const crashTestEndpointUrl = `https://data.austintexas.gov/resource/${crashDatasetID}.json`
export const crashGeoJSONEndpointUrl = `https://data.austintexas.gov/resource/${crashDatasetID}.geojson`;
export const personEndpointUrl = `https://data.austintexas.gov/resource/${demographicsDatasetID}.json`;
