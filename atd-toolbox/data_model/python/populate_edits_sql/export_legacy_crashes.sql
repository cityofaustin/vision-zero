select
    ...
    investigat_da_id,
    latitude_primary as latitude,
    longitude_primary as longitude,
    est_comp_cost,
    est_econ_cost,
    position,
    ...
    apd_human_update,
    speed_mgmt_points,
    coalesce(investigator_narrative, investigator_narrative_ocr) as investigator_narrative,
    rpt_sec_speed_limit,
    near_trauma_center_id,
    near_trauma_center_distance,
    TO_CHAR(crash_date, 'MM/DD/YYYY') as crash_date,
    TO_CHAR(crash_time, 'HH:MI AM') as crash_time
from atd_txdot_crashes where crash_date < '2014-01-01';
