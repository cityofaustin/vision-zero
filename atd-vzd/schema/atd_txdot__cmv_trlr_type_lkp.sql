...
-- Started on 2019-10-15 13:50:49 CDT
...
--
-- TOC entry 270 (class 1259 OID 2345966)
...
CREATE TABLE public.atd_txdot__cmv_trlr_type_lkp (
    trlr_type_id integer NOT NULL,
    trlr_type_desc character varying(128),
...
--
-- TOC entry 5618 (class 2606 OID 2346550)
...
ALTER TABLE ONLY public.atd_txdot__cmv_trlr_type_lkp
    ADD CONSTRAINT atd_txdot__cmv_trlr_type_lkp_pk PRIMARY KEY (trlr_type_id);


-- Completed on 2019-10-15 13:50:53 CDT
