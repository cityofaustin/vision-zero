...
-- Started on 2019-10-15 14:01:06 CDT
...
--
-- TOC entry 366 (class 1259 OID 2347756)
-- Name: atd_txdot_primaryperson_backup; Type: TABLE; Schema: public; Owner: atd_vz_data
--

CREATE TABLE public.atd_txdot_primaryperson_backup (
    crash_id integer,
    unit_nbr integer,
    prsn_nbr integer,
    ...
    drvr_lic_number character varying(64),
    drvr_lic_cls_id integer,
    drvr_dob date,
    drvr_street_nbr character varying(32),
    drvr_street_pfx character varying(32),
    drvr_street_name character varying(256),
    drvr_street_sfx character varying(32),
    drvr_apt_nbr character varying(32),
...
ALTER TABLE public.atd_txdot_primaryperson_backup OWNER TO atd_vz_data;

-- Completed on 2019-10-15 14:01:10 CDT
