-- This function is invoked by a generated column in atd_txdot_crashes called in_austin_full_purpose and determines whether crash coordinates fall within 
-- the Austin Full Purpose jurisdiction polygon. If the crash has no coordinates, it returns whether the crash is in Austin (city_id = 5)
