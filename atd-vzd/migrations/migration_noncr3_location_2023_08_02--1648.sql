...
-- 2. Drop materialized views that use location_id and branch from all_atd_apd_blueform
...
-- 3. Drop materialized views that use location_id and branch from five_year_atd_apd_blueform
...
-- 4. Drop functions that were removed and rolled into update_noncr3_location function
