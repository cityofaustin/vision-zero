...
DROP IF EXISTS FUNCTION find_cr3_mainlane_crash;
DROP IF EXISTS FUNCTION find_location_for_cr3_collision;
DROP IF EXISTS FUNCTION find_location_id_for_cr3_collision;
