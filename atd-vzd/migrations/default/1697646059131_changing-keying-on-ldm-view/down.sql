...
AS SELECT atd_txdot_person_1.crash_id,
   ...
   FROM vz_facts.atd_txdot_person
     JOIN cris_facts.atd_txdot_person atd_txdot_person_1 ON atd_txdot_person.crash_id = atd_txdot_person_1.crash_id AND atd_txdot_person.unit_nbr = atd_txdot_person_1.unit_nbr AND atd_txdot_person.prsn_nbr = atd_txdot_person_1.prsn_nbr AND atd_txdot_person.prsn_type_id = atd_txdot_person_1.prsn_type_id AND atd_txdot_person.prsn_occpnt_pos_id = atd_txdot_person_1.prsn_occpnt_pos_id;
