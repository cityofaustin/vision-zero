...
BEFORE INSERT ON public.atd_txdot_crashes
FOR EACH ROW
...
BEFORE UPDATE ON public.atd_txdot_crashes
FOR EACH ROW
...
DROP FUNCTION IF EXISTS find_cr3_mainlane_crash;
DROP FUNCTION IF EXISTS find_location_for_cr3_collision;
DROP FUNCTION IF EXISTS find_location_id_for_cr3_collision;
