...
-- Started on 2019-10-15 13:51:15 CDT
...
--
-- TOC entry 5618 (class 2606 OID 2346564)
...
ALTER TABLE ONLY public.atd_txdot__cnty_lkp
    ADD CONSTRAINT atd_txdot__cnty_lkp_pk PRIMARY KEY (cris_cnty_id);


-- Completed on 2019-10-15 13:51:19 CDT
