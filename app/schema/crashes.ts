...
export const crashSchema = z.object({
  ...
  collsn: lookupOptionSchema.nullable(),
  ...
  obj_struck: lookupOptionSchema.nullable(),
  ...
  change_logs: z.array(changeLogEntrySchema).nullable(),
  units: z.array(unitSchema).nullable().nullable(),
});
