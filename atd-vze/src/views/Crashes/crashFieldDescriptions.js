...
export const crashFieldDescription = {
  ...
  unit: {
    ...
    veh_dmag_area_1_id: { type: "integer" },
    veh_dmag_scl_1_id: { type: "integer" },
    force_dir_1_id: { type: "integer" },
    veh_dmag_area_2_id: { type: "integer" },
    veh_dmag_scl_2_id: { type: "integer" },
    force_dir_2_id: { type: "integer" },
