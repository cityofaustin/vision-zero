...
CREATE OR REPLACE VIEW crash_injury_metrics_view AS SELECT
    ...
    COALESCE(SUM(person_injury_metrics_view.unkn_injry), 0::bigint)
        AS unkn_injry_count,
    ...
    COALESCE(SUM(person_injury_metrics_view.poss_injry), 0::bigint)
        AS poss_injry_count,
    COALESCE(SUM(person_injury_metrics_view.non_injry), 0::bigint)
        AS non_injry_count,
    COALESCE(SUM(person_injury_metrics_view.sus_serious_injry), 0::bigint)
        AS sus_serious_injry_count,
    COALESCE(SUM(person_injury_metrics_view.nonincap_injry), 0::bigint)
    + COALESCE(SUM(person_injury_metrics_view.poss_injry), 0::bigint)
    + COALESCE(SUM(person_injury_metrics_view.sus_serious_injry), 0::bigint)
        AS tot_injry_count,
    COALESCE(SUM(person_injury_metrics_view.fatal_injury), 0::bigint)
        AS fatality_count,
    COALESCE(SUM(person_injury_metrics_view.vz_fatal_injury), 0::bigint)
        AS vz_fatality_count,
    COALESCE(SUM(person_injury_metrics_view.law_enf_fatal_injury), 0::bigint)
        AS law_enf_fatality_count,
    COALESCE(SUM(person_injury_metrics_view.cris_fatal_injury), 0::bigint)
    ...
    COALESCE(SUM(person_injury_metrics_view.motorcycle_fatal_injry), 0::bigint)
    ...
    COALESCE(SUM(person_injury_metrics_view.bicycle_fatal_injry), 0::bigint)
    ...
    COALESCE(SUM(person_injury_metrics_view.pedestrian_fatal_injry), 0::bigint)
    ...
    COALESCE(SUM(person_injury_metrics_view.other_fatal_injry), 0::bigint)
        AS other_fatality_count,
    COALESCE(SUM(person_injury_metrics_view.other_sus_serious_injry), 0::bigint)
    ...
    COALESCE(SUM(person_injury_metrics_view.years_of_life_lost), 0::bigint)
        AS years_of_life_lost,
    COALESCE(MAX(person_injury_metrics_view.est_comp_cost_crash_based), 20000)
