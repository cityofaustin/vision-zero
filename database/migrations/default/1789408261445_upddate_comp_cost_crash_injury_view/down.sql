-- set unknown est comp cost back to 20000
...
SELECT
    ...
    + COALESCE(SUM(person_injury_metrics_view.sus_serious_injry), 0::bigint) AS tot_injry_count,
    COALESCE(
    ...
    COALESCE(
        SUM(person_injury_metrics_view.motor_vehicle_sus_serious_injry), 0::bigint
    ...
    COALESCE(
        SUM(person_injury_metrics_view.micromobility_sus_serious_injry), 0::bigint
