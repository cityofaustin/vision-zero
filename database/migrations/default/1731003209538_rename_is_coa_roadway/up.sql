...
comment on column public.crashes.is_coa_roadway is 'If the crash location occurred within the City of Austin, not on a private drive, and not intersecting with the non_coa_roadways layer. Set via trigger.';
