...
BEGIN
    ...
    IF TG_OP = 'UPDATE' THEN
        ...
        -- First check if there are any EMS records that reference this case_id
        -- This avoids the expensive query when there are no matches
        ...
        IF cleanup_count > 0 THEN
            ...
            LOOP
                -- Remove the case_id from the matched_non_cr3_case_ids array
