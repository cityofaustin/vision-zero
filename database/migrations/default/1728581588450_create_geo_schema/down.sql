alter table geo.engineering_areas set schema public;
alter table geo.signal_engineer_areas set schema public;
alter table geo.council_districts set schema public;
alter table geo.apd_sectors set schema public;
alter table geo.zip_codes set schema public;
alter table geo.non_coa_roadways set schema public;
alter table geo.atd_jurisdictions set schema public;
